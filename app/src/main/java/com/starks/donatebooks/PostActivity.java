...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText2 = (EditText) findViewById(R.id.loc);
        editText3 = (EditText) findViewById(R.id.cat);
        editText6 = (EditText) findViewById(R.id.subcat);
    ...
    private void post() {
        ...
        String cat = editText3.getText().toString();
        String subcat = editText6.getText().toString();
        String desc = editText4.getText().toString();
        String cinfo = editText5.getText().toString();

        if (!TextUtils.isEmpty(bloodtype) && !TextUtils.isEmpty(location) && !TextUtils.isEmpty(cat)) {
